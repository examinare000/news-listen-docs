...
```
TechNewsPodcast/
├── TechNewsPodcastApp.swift        # @main エントリポイント
...
1. File → New → Project
2. iOS → App を選択
3. Product Name: `TechNewsPodcast`
4. Interface: `SwiftUI`
5. Language: `Swift`
...
- Bundle Identifier: `com.yourname.technewspodcast`

- [ ] **Step 3: プロジェクトを git に追加**
...
**Files:**
- Create: `ios/TechNewsPodcast/Models/Article.swift`
- Create: `ios/TechNewsPodcast/Models/Podcast.swift`
- Create: `ios/TechNewsPodcast/Models/RssSource.swift`

- [ ] **Step 1: テストを書く（RED）**

`Tests/TechNewsPodcastTests/ModelTests.swift` を作成:

```swift
import XCTest
@testable import TechNewsPodcast
...
```swift
// ios/TechNewsPodcast/Models/Article.swift
import Foundation
...
```swift
// ios/TechNewsPodcast/Models/Podcast.swift
import Foundation
...
```swift
// ios/TechNewsPodcast/Models/RssSource.swift
import Foundation
...
```bash
git add ios/TechNewsPodcast/Models/ ios/TechNewsPodcastTests/ModelTests.swift
...
**Files:**
- Create: `ios/TechNewsPodcast/Networking/APIEndpoint.swift`
- Create: `ios/TechNewsPodcast/Networking/APIClient.swift`

- [ ] **Step 1: テストを書く（RED）**

`Tests/TechNewsPodcastTests/APIClientTests.swift` を作成:
...
```swift
// ios/TechNewsPodcast/Networking/APIEndpoint.swift
import Foundation
...
```swift
// ios/TechNewsPodcast/Networking/APIClient.swift
import Foundation
...
```bash
git add ios/TechNewsPodcast/Networking/ ios/TechNewsPodcastTests/APIClientTests.swift
...
**Files:**
- Create: `ios/TechNewsPodcast/AppState.swift`
- Modify: `ios/TechNewsPodcast/TechNewsPodcastApp.swift`

- [ ] **Step 1: AppState.swift を作成**

```swift
// ios/TechNewsPodcast/AppState.swift
import Foundation
import Combine
...
- [ ] **Step 2: TechNewsPodcastApp.swift を更新**

```swift
// ios/TechNewsPodcast/TechNewsPodcastApp.swift
import SwiftUI

@main
struct TechNewsPodcastApp: App {
...
```bash
git add ios/TechNewsPodcast/AppState.swift ios/TechNewsPodcast/TechNewsPodcastApp.swift
...
**Files:**
- Create: `ios/TechNewsPodcast/Feed/FeedViewModel.swift`
- Create: `ios/TechNewsPodcast/Feed/ArticleRowView.swift`
- Create: `ios/TechNewsPodcast/Feed/FeedView.swift`
- Create: `ios/TechNewsPodcastTests/FeedViewModelTests.swift`

- [ ] **Step 1: FeedViewModel のテストを書く（RED）**

```swift
// ios/TechNewsPodcastTests/FeedViewModelTests.swift
import XCTest
@testable import TechNewsPodcast
...
```swift
// ios/TechNewsPodcast/Feed/FeedViewModel.swift
import Foundation
...
```swift
// ios/TechNewsPodcast/Feed/ArticleRowView.swift
import SwiftUI
...
```swift
// ios/TechNewsPodcast/Feed/FeedView.swift
import SwiftUI
...
```bash
git add ios/TechNewsPodcast/Feed/ ios/TechNewsPodcastTests/FeedViewModelTests.swift
...
**Files:**
- Create: `ios/TechNewsPodcast/Podcast/PodcastViewModel.swift`
- Create: `ios/TechNewsPodcast/Podcast/AudioPlayerView.swift`
- Create: `ios/TechNewsPodcast/Podcast/PodcastRowView.swift`
- Create: `ios/TechNewsPodcast/Podcast/PodcastView.swift`
- Create: `ios/TechNewsPodcastTests/PodcastViewModelTests.swift`

- [ ] **Step 1: PodcastViewModel のテストを書く（RED）**

```swift
// ios/TechNewsPodcastTests/PodcastViewModelTests.swift
import XCTest
@testable import TechNewsPodcast
...
```swift
// ios/TechNewsPodcast/Podcast/PodcastViewModel.swift
import Foundation
import AVFoundation
...
```swift
// ios/TechNewsPodcast/Podcast/AudioPlayerView.swift
import SwiftUI
...
```swift
// ios/TechNewsPodcast/Podcast/PodcastRowView.swift
import SwiftUI
...
```swift
// ios/TechNewsPodcast/Podcast/PodcastView.swift
import SwiftUI
...
```bash
git add ios/TechNewsPodcast/Podcast/ ios/TechNewsPodcastTests/PodcastViewModelTests.swift
...
**Files:**
- Create: `ios/TechNewsPodcast/Settings/SettingsViewModel.swift`
- Create: `ios/TechNewsPodcast/Settings/SettingsView.swift`
- Create: `ios/TechNewsPodcastTests/SettingsViewModelTests.swift`

- [ ] **Step 1: SettingsViewModel のテストを書く（RED）**

```swift
// ios/TechNewsPodcastTests/SettingsViewModelTests.swift
import XCTest
@testable import TechNewsPodcast
...
```swift
// ios/TechNewsPodcast/Settings/SettingsViewModel.swift
import Foundation
...
```swift
// ios/TechNewsPodcast/Settings/SettingsView.swift
import SwiftUI
...
```bash
git add ios/TechNewsPodcast/Settings/ ios/TechNewsPodcastTests/SettingsViewModelTests.swift
